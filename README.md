...
```hcl
    module "labels" {
      source        = "git::https://github.com/opsstation/terraform-azure-labels.git?ref=v1.0.0"  # Update with the correct path to the module
      name          = "app"
      environment   = "test"
...
## License
This project is licensed under the MIT License - see the [LICENSE](https://github.com/opsstation/terraform-azure-labels.git/blob/master/LICENSE) file for details.
